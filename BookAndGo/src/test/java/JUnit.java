...
public class JUnit {
	...
	//This is sample test case to show that junit is up and running
	@Test
	   public void testSetup() {
	      String str= "I am done with Junit setup";
	      assertEquals("I am done with Junit setup",str);
	}
	//This is sample test case to show that database connection is up and running
	@Test
	public void ConnectionTest() throws SQLException {
		String dbName = "Sample";
	      ...
	      String port = "3306";
	      String jdbcUrl = "jdbc:mysql://ssdi-project-db.cxqdrxxfwjtl.us-east-2.rds.amazonaws.com:3306/Sample?useSSL=false";
